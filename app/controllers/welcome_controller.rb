class WelcomeController < ApplicationController
  ...
  def bands
    ...
    bookings.each do |booking|
      if booking.event != nil and booking.event != "" and booking.event.status != "RELEASED" and booking.event.status != "BAB" and booking.event.status != "BADJ" and booking.event.status != "RELEASED-$$$" and booking.event.status != "BAB-$$$" and booking.event.status != "BADJ-$$$" and booking.event.status != "RELEASED-FULLY BOOKED" && booking.event.status != "RELEASED-BAB" and booking.event.status != "RELEASED-BADJ" and good_bookings.exclude?(booking.date)
